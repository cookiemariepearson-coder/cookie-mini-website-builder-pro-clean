...
function TemplateHeroVisual({ site, icon, label, tags, profile, businessName }) {
  ...
  const scenes = {
    food: <div className="templateScene foodScene"><span className="sceneSteam">〰 〰 〰</span><div className="foodPlate"><b>🍗</b><i>🥬</i><em>🍚</em></div><strong>Fresh from the kitchen</strong><small>Made to order • Pickup • Catering</small></div>,
