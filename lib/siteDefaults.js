...
export const templateLibrary = [
  ...
  },
  {
    type: 'Local Services', key: 'local', styles: [
      { key: 'service-3d', name: 'Home Repair Pro', art: '🛠️', mood: 'dependable home repairs and skilled workmanship', visual: 'Realistic workshop hero, bold service panels and project trust showcase', palette: { primary: '#20252b', accent: '#e77824' } },
      { key: 'service-realistic', name: 'Neighborhood Service Studio', art: '🏪', mood: 'friendly storefront and community service', visual: 'Welcoming storefront hero, warm appointment panels and neighborhood story layout', palette: { primary: '#385467', accent: '#d98261' } }
  ...
  },
  {
    type: 'Digital Product Seller', key: 'digital', styles: [
      { key: 'bold-sales', name: 'Midnight Digital Sales', art: '💻', mood: 'bold midnight product launch', visual: 'Dark editorial hero, high-impact product panels and modern sales story', palette: { primary: '#15133b', accent: '#7b3ff2' } },
      { key: 'creator-tool', name: 'Bright Creator Studio', art: '⚙️', mood: 'bright creator workspace', visual: 'Colorful studio hero, creator product cards and playful resource gallery', palette: { primary: '#150e28', accent: '#f0a21f' } }
  ...
  },
  {
    type: 'Nonprofit / Community', key: 'nonprofit', styles: [
      { key: 'warm-mission', name: 'Warm Community Mission', art: '🤝', mood: 'welcoming community support', visual: 'Warm volunteer hero, natural program cards and community story collage', palette: { primary: '#24315a', accent: '#c66b2d' } },
      { key: 'bold-action', name: 'Bold Community Action', art: '📣', mood: 'energetic community action', visual: 'Navy action hero, vivid program panels and high-impact volunteer gallery', palette: { primary: '#16264a', accent: '#ef5b32' } }
  ...
  },
  {
    type: 'Portfolio / Film / Creator', key: 'creator', styles: [
      { key: 'cinematic', name: 'Cinematic Production', art: '🎬', mood: 'dramatic film production', visual: 'Film-set hero, black-and-gold work panels and cinematic project gallery', palette: { primary: '#12081f', accent: '#c28b45' } },
      { key: 'cartoon-creative', name: 'Colorful Creator Studio', art: '🎨', mood: 'bright creative studio', visual: 'Pastel creator workspace, colorful work cards and lively portfolio gallery', palette: { primary: '#50315f', accent: '#ff6b9f' } }
  ...
  },
  {
    type: 'Cleaning / Home Services', key: 'cleaning', styles: [
      { key: 'clean-realistic', name: 'Premium Home Cleaning', art: '✨', mood: 'refined premium cleaning', visual: 'Navy luxury interior hero, polished service cards and dramatic results collage', palette: { primary: '#16334a', accent: '#b89354' } },
      { key: 'cartoon-sparkle', name: 'Bright Friendly Cleaning', art: '🧽', mood: 'fresh friendly cleaning', visual: 'Airy turquoise hero, cheerful service panels and bright before-and-after collage', palette: { primary: '#276a75', accent: '#55cbd5' } }
  ...
  },
  {
    type: 'Coaching / Consulting', key: 'coaching', styles: [
      { key: 'expert-clean', name: 'Modern Expert Coach', art: '📘', mood: 'confident modern coaching', visual: 'Modern advisor hero, structured blue service cards and strategy story gallery', palette: { primary: '#1e2639', accent: '#6c8fc5' } },
      { key: 'luxury-advisor', name: 'Luxury Business Advisor', art: '💼', mood: 'executive premium consulting', visual: 'Dark executive office hero, espresso-and-gold packages and success gallery', palette: { primary: '#17120f', accent: '#b98938' } }
  ...
  },
  {
    type: 'Kids / Party / Fun', key: 'party', styles: [
      { key: 'cartoon-bright', name: 'Sunny Celebration', art: '🎈', mood: 'sunny colorful celebration', visual: 'Outdoor birthday illustration, balloon package cards and cheerful party gallery', palette: { primary: '#4d55a8', accent: '#ff796f' } },
      { key: 'color-pop', name: 'Neon Block Party', art: '🎉', mood: 'energetic neighborhood event', visual: 'Deep navy neon hero, music-inspired package panels and block-party gallery', palette: { primary: '#071a4a', accent: '#ff9d00' } }
  ...
  },
  {
    type: 'Online Shop / Boutique', key: 'shop', styles: [
      { key: 'luxury-product', name: 'Midnight Luxury Boutique', art: '🛍️', mood: 'midnight premium boutique', visual: 'Black-and-plum product hero, gold-framed product cards and editorial gallery', palette: { primary: '#170f18', accent: '#b98954' } },
      { key: 'storefront-realistic', name: 'Neighborhood Boutique', art: '🏬', mood: 'warm welcoming storefront', visual: 'Sunlit sage storefront hero, earthy product panels and friendly shop gallery', palette: { primary: '#425747', accent: '#c96f4c' } }
...
export function planSectionLimit(plan = 'free', extraPages = 0) {
  const info = plans[plan] || plans.free;
  const base = Number(info.maxSections || info.maxPages || 1);
  if (base >= 99) return base;
  return base + Math.max(0, Math.min(20, Number(extraPages) || 0));
}
...
export function normalizeSelectedPagesForPlan(pages = ['Home'], plan = 'free', extraPages = 0) {
  const limit = planSectionLimit(plan, extraPages);
...
export function visiblePagesForPlan(site) {
  return normalizeSelectedPagesForPlan(site?.pages || ['Home'], site?.plan || 'free', site?.extraPages || site?.extra_pages);
}
