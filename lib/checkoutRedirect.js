...
export default async function CheckoutRedirectPage({ plan, intentId = '' }) {
  ...
  return (
    <main className="wrap dashboard">
      <span className="kicker">Secure checkout unavailable</span>
      <h1>We could not open {planLabels[plan] || 'this checkout'}.</h1>
      <p>Open your saved website and use its checkout button so the purchase stays connected to the correct website.</p>
