...
export default function VideoStudio(){
 ...
 async function createRealVideo(){
   ...
   setLoading(true);
   try{
     const res=await fetch('/api/heygen/create',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({businessName:biz,promo,audience:aud,videoType:type,platform,style,length,voice,accessCode})});
 ...
 async function checkStatus(){
   ...
   try{
     const res=await fetch('/api/heygen/status',{method:'POST',headers:{'Content-Type':'application/json'},body:JSON.stringify({sessionId:job.sessionId,videoId:job.videoId})});
