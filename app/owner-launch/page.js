...
const groups = [
  ...
  ['Vercel setup', ['All Gumroad checkout links are in Environment Variables', 'Supabase URL and service role key are in Environment Variables', 'The canonical owner identity is enforced by the server', 'cookiesdigitalcreations.com, www, and wildcard are valid']],
  ...
  ['Launch habit', ['Test a free site once per week', 'Review unresolved Gumroad events weekly', 'Run Recheck before Reconcile and never assign a paid plan manually', 'Keep a note for customer requests inside Admin Notes', 'Use Archive instead of permanent delete unless the customer requests deletion']]
];
