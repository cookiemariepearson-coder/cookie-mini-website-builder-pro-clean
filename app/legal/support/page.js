  ...
  return (
    ...
    >
      <PolicySection title="1. Before contacting support">
        <PolicyList items={[
          'Sign in to My Websites. Only records owned by the verified customer account will load; the private list can then be filtered by website name or address.',
      ...
      <PolicySection title="3. Response expectations">
        <p>Support may include troubleshooting, correcting a website record, helping locate drafts, pausing/archiving sites, or explaining subscription access. Paid plan corrections require authoritative provider evidence and protected reconciliation. Support does not guarantee sales, marketing results, search ranking, or third-party platform approval.</p>
      </PolicySection>
