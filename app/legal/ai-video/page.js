...
export default function AiVideoPolicyPage() {
  return (
    <LegalPolicyPage
      ...
      subtitle="This policy explains creative video kits, real AI video generation, HeyGen access, plan limits, and customer responsibility for generated content."
    >
      <PolicySection title="1. Creative kit mode">
        <p>AI Video Studio may provide scripts, captions, shot lists, voiceover ideas, and AI video prompts. These creative kits help customers prepare promotional content and do not always create a finished video file.</p>
      </PolicySection>
      ...
      <PolicySection title="3. Current plan limits">
        <PolicyList items={[
          'Free: creative kit only unless manually approved by the owner/admin.',
          'Starter Pro: creative kit only unless manually approved by the owner/admin.',
      ...
      <PolicySection title="4. Customer responsibility">
      ...
      <PolicySection title="5. Prohibited AI video requests">
      ...
      <PolicySection title="6. Credits and failures">
      ...
      <PolicySection title="7. No guarantee of performance">
